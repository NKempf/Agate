...
# Statistiques discretes RP et mise à jours table finale
...
statistics_zone <- function(group_var,rpi,rpl,filo,sourceRpi,sourceRpl,sourceFilo,rpi.weight,rpl.weight,filo.weight){
