...
source("Catalogue de fonctions/Agate - Fonction qualite RP infra.R",encoding = "UTF-8")
...
RPStats <- precision_analytique_nc(rpa = rpa,Y = Y,zonage = zonage,idZonage = idZonage)
